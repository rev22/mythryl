...
etags:
	@-echo */*.sml */*/*.sml */*/*/*.sml */*/*/*/*.sml */*/*/*/*/*.sml */*/*/*/*/*/*.sml */*/*/*/*/*/**/.sml \
...
MAKE7_FILE_HIERARCHY.INFO~:
	  ...
	  src/lib/compiler/lower/make7/peephole.make6 \
...
somewhat-clean:	ppless
	...
	@-(cd src/lib/x-kit/tut/ml-viewer;  make  clean)  # --no-print-directory 
	@#-rm -rf bin
	@-rm -f core
	...
	@find . -type f -name '*.COMPILE_LOG' -print | xargs rm -f;
	@find . -type f -name '*.COMPILE_LOG2' -print | xargs rm -f;
	...
	@rm -rf rm-rf-me;
	@rm -f mythryld;
	@rm -f src/lib/c-kit/src/parser/grammar/c.grm.desc;
	@rm -f src/lib/c-kit/src/parser/grammar/c.grm.api;
	@rm -f src/lib/c-kit/src/parser/grammar/c.grm.pkg;
	@rm -f src/lib/c-kit/src/parser/grammar/c.grm.sml;
	@rm -f src/lib/c-kit/src/parser/grammar/c.lex.pkg;
	@rm -f src/lib/c-kit/src/parser/grammar/c.lex.sml;
	@rm -f src/app/make7/parse/make7.grammar.desc;
	@rm -f src/app/make7/parse/make7.grammar.sig;
	@rm -f src/app/make7/parse/make7.grammar.pkg;
	@rm -f src/app/make7/parse/make7.grammar.sml;
	@rm -f src/app/make7/parse/make7.lex.pkg;
	@rm -f src/app/make7/parse/make7.lex.sml;
	@rm -f src/app/yacc/src/mythryl-yacc;
	@rm -f src/lib/compiler/front/parse/lex/mythryl.lex.pkg;
	@rm -f src/lib/compiler/front/parse/lex/mythryl.lex.sml;
	@rm -f src/lib/compiler/front/parse/yacc/mythryl.grammar.desc;
	@rm -f src/lib/compiler/front/parse/yacc/mythryl.grammar.api;
	@rm -f src/lib/compiler/front/parse/yacc/mythryl.grammar.sig;
	@rm -f src/lib/compiler/front/parse/yacc/mythryl.grammar.sml;
	@rm -f src/lib/compiler/front/parse/yacc/mythryl.grammar.pkg;
	@rm -f src/lib/compiler/front/parse/lex/nada.lex.pkg;
	@rm -f src/lib/compiler/front/parse/lex/nada.lex.sml;
	@rm -f src/lib/compiler/front/parse/yacc/nada.grammar.desc;
	@rm -f src/lib/compiler/front/parse/yacc/nada.grammar.sig;
	@rm -f src/lib/compiler/front/parse/yacc/nada.grammar.pkg;
	@rm -f src/lib/compiler/front/parse/yacc/nada.grammar.sml;
	@rm -f src/app/burg/burg.lex.pkg;
	@rm -f src/app/burg/burg.lex.sml;
	@rm -f src/lib/compiler/lower/tools/parser/mdl.grm.desc;
	@rm -f src/lib/compiler/lower/tools/parser/mdl.grm.api;
	@rm -f src/lib/compiler/lower/tools/parser/mdl.grm.pkg;
	@rm -f src/lib/compiler/lower/tools/parser/mdl.grm.sml;
	@rm -f src/lib/compiler/lower/tools/parser/mdl.lex.pkg;
	@rm -f src/lib/compiler/lower/tools/parser/mdl.lex.sml;
	@rm -f src/lib/html/html-gram.desc;
	@rm -f src/lib/html/html-gram.sig;
	@rm -f src/lib/html/html-gram.pkg;
	@rm -f src/lib/html/html-gram.sml;
	@rm -f src/lib/html/html-lex.pkg;
	@rm -f src/lib/html/html-lex.sml;
	@rm -f src/app/future-lex/src/front-ends/lex/mythryl-lex.grammar.sig
	@rm -f src/app/future-lex/src/front-ends/lex/mythryl-lex.grammar.sml
	...
	@# -find . -name '*.grm.desc' -print | xargs rm
	@# -find . -name '*.grm.sig' -print | xargs rm
	@# -find . -name '*.grm.sml' -print | xargs rm
	@# -find . -name '*.lex.sml' -print | xargs rm
